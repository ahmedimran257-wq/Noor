...
class _IslamicIdentityScreenState extends State<IslamicIdentityScreen> {
  ...
  String? _hijab;
  String?
      _beardStyle; // 'yes','no','prefer_not_to_say' — maps to profiles.beard
  ...
  Future<void> _advance() async {
    ...
    final data = context.read<OnboardingCubit>().currentData.copyWith(
          ...
          vapingHabit: _vapingHabit,
          hookahHabit: _hookahHabit,
          isRevert: _isRevert,
        );
    await context.read<OnboardingCubit>().saveAndAdvance(data);
  }
  ...
  String _getLocalizedHijab(AppLocalizations l10n, String raw) {
    switch (raw) {
      case 'Always':
        return l10n.onboarding_hijab_always;
      case 'Sometimes':
        return l10n.onboarding_hijab_sometimes;
      case 'No':
        return l10n.onboarding_hijab_no;
      case 'Prefer not to say':
  ...
  String _getLocalizedHabit(AppLocalizations l10n, String raw) {
    switch (raw) {
      case 'Never':
        return l10n.onboarding_habit_never;
      case 'Occasionally':
        return l10n.onboarding_habit_occasionally;
      case 'Frequently':
        return l10n.onboarding_habit_frequently;
      case 'Prefer not to say':
        return l10n.onboarding_habit_preferNotToSay;
    }
    return raw;
  }
  ...
  String _getLocalizedDiet(AppLocalizations l10n, String key) {
    switch (key) {
      case 'zabiha_strict':
        return l10n.onboarding_diet_zabihaStrict;
      case 'halal_only':
        return l10n.onboarding_diet_halalOnly;
      case 'eats_anything':
        return l10n.onboarding_diet_eatsAnything;
      case 'vegetarian':
        return l10n.onboarding_diet_vegetarian;
      case 'vegan':
        return l10n.onboarding_diet_vegan;
    }
    return key;
  }
        ...
        return OnboardingScaffold(
          ...
          body: Column(
            ...
            children: [
              ...
              StepHeader(
                  title: l10n.onboarding_islamicIdentity_title,
                  subtitle: l10n.onboarding_islamicIdentity_subtitle),
              const SizedBox(height: AppDimensions.space32),
              ...
              _ChipGroup<Sect>(
                ...
                label: (s) {
                  switch (s) {
                    case Sect.sunni:
                      return l10n.onboarding_label_sunni;
                    case Sect.shia:
                      return l10n.onboarding_label_shia;
              ...
              if (_sect == Sect.sunni || _sect == Sect.shia) ...[
                ...
                Wrap(
                  ...
                  children: _subSects
                      .map((s) => _SelectChip(
                            label: _getLocalizedSubSect(l10n, s),
              ...
              _SectionTitle(
                  CopyEngine.prayerQuestion(l10n, _relation).toUpperCase()),
              const SizedBox(height: AppDimensions.space12),
              Row(children: [
                Expanded(
                    child: _TogglePill(
              ...
              if (_gender == Gender.female) ...[
                const SizedBox(height: AppDimensions.space20),
                _SectionTitle(
                    CopyEngine.hijabQuestion(l10n, _relation, 'female')
                        .toUpperCase()),
                const SizedBox(height: AppDimensions.space12),
                Wrap(
                  spacing: AppDimensions.space8,
                  runSpacing: AppDimensions.space8,
                  children: _hijabOptions
                      .map((o) => _SelectChip(
                            label: _getLocalizedHijab(l10n, o),
                            isSelected: _hijab == o,
                            onTap: () =>
                                setState(() => _hijab = _hijab == o ? null : o),
                          ))
                      .toList(),
                ),
              ],
              ...
              if (_gender == Gender.male) ...[
                const SizedBox(height: AppDimensions.space20),
                _SectionTitle(
                    CopyEngine.beardQuestion(l10n, _relation).toUpperCase()),
                const SizedBox(height: AppDimensions.space12),
                Wrap(
                  spacing: AppDimensions.space8,
                  runSpacing: AppDimensions.space8,
                  ...
                  children: {
                    ...
                    'prefer_not_to_say': l10n.onboarding_label_preferNotToSay,
                      ...
                      .map((e) => _SelectChip(
                            ...
                            onTap: () =>
                                setState(() => _religiousLeadership = e.key),
                          ))
                      .toList(),
                ),
              ],
              ...
              Wrap(
                ...
                children: _dietOptions
                    .map((opt) => _SelectChip(
                          label: _getLocalizedDiet(l10n, opt.$2),
                          isSelected: _dietType == opt.$2,
              ...
              Wrap(
                spacing: AppDimensions.space8,
                runSpacing: AppDimensions.space8,
                children: _habitOptions
                    .map((o) => _SelectChip(
                          label: _getLocalizedHabit(l10n, o),
  ...
  String _deenLabel(AppLocalizations l10n, DeenLevel d) {
    switch (d) {
      case DeenLevel.practicing:
        return l10n.onboarding_label_practicing;
      case DeenLevel.moderate:
        return l10n.onboarding_label_moderate;
      case DeenLevel.cultural:
        return l10n.onboarding_label_cultural;
    }
  }
}
