...
// ============================================================
// NOOR — Legal Document Screen
// Displays Terms of Service or Privacy Policy content.
// Uses the NOOR Quiet Luxury design language.
//
...
const _tosSections = <_LegalSection>[
  _LegalSection(
    ...
    body: 'By creating an account on NOOR, you agree to be bound by these '
        'Terms of Service. NOOR is a matrimony platform designed for the '
  ...
  _LegalSection(
    title: '2. Eligibility',
    body: 'You must be at least 18 years old to use NOOR. By using the app, '
  ...
  _LegalSection(
    title: '4. Conduct',
    body: 'NOOR is a safe space. Users are expected to interact with adab '
  ...
  _LegalSection(
    ...
    body: 'NOOR offers free and premium tiers. Women always message free. '
  ...
  _LegalSection(
    ...
    body: 'You may delete your account at any time from the Settings screen. '
        'NOOR reserves the right to suspend or terminate accounts that violate '
        'these terms. Upon deletion, your personal data will be removed in '
        'accordance with our Privacy Policy.',
  ),
  _LegalSection(
    title: '7. Disclaimer',
    body: 'NOOR does not conduct background checks on users. We are not '
        'responsible for the conduct of users on or off the platform. NOOR '
...
const _privacySections = <_LegalSection>[
  ...
  _LegalSection(
    ...
    body: 'NOOR respects your photo privacy preferences. You may choose to '
  ...
  _LegalSection(
    ...
    body: 'For any privacy-related questions or concerns, please contact '
        ...
        'privacy@noor.app. We aim to respond to all inquiries within '
        '48 hours.',
  ),
];
