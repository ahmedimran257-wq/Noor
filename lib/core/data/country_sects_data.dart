  ...
  static CountrySectConfig forCountry(String rawIso2) {
    ...
    if (iso2 == 'TR') {
      return const CountrySectConfig(
        ...
        sensitivityNote:
            'Turkey has a diverse Islamic tradition. Select what feels closest to your background.',
      );
    }
    ...
    if ([
      ...
      return const CountrySectConfig(
        ...
        sects: [
          ...
          'Ahmadiyya',
          'Sufi',
          'Quran-only / Non-denominational',
          'Convert — still learning',
          'Other',
          'Prefer not to say',
        ],
        subSects: {
    ...
    if (iso2 == 'AZ') {
      return const CountrySectConfig(
        ...
        sects: [
          'Shia (majority)',
          'Sunni',
          'Non-practising / Secular background',
          'Other',
          'Prefer not to say',
        ],
        subSects: {},
