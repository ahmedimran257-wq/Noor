// lib/core/config/country_demographics/southeast_asia.dart
// MITHAQ — Southeast Asian Demographics
...
const kSoutheastAsiaDemographics = <String, Map<String, List<String>>>{
  ...
  'MY': {
    ...
    'languages': ['Malay', 'English', 'Tamil', 'Arabic', 'Other'],
  },
  'BN': {
    'communities': ['Bruneian Malay', 'Kedayan', 'Other'],
    'languages': ['Malay', 'English', 'Other'],
  },
  'SG': {
    'communities': ['Malay', 'Indian Muslim', 'Arab', 'Other'],
    'languages': ['Malay', 'English', 'Tamil', 'Other'],
  },
  'PH': {
  ...
  'TH': {
    ...
    'languages': ['Thai', 'Malay', 'Other'],
  },
  'MM': {
    'communities': ['Rohingya', 'Other'],
    'languages': ['Rohingya', 'Burmese', 'Other'],
  },
};
