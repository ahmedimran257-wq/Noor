// lib/core/widgets/loaders/mithaq_shimmer.dart
// ============================================================
// MITHAQ Loading States
...
class MithaqShimmer extends StatefulWidget {
  const MithaqShimmer({
    super.key,
    required this.child,
    this.enabled = true,
  ...
  @override
  State<MithaqShimmer> createState() => _MithaqShimmerState();
}

class _MithaqShimmerState extends State<MithaqShimmer>
...
class MithaqProfileCardShimmer extends StatelessWidget {
  const MithaqProfileCardShimmer({super.key});

  @override
  Widget build(BuildContext context) {
    return MithaqShimmer(
      child: AspectRatio(
...
class MithaqConversationShimmer extends StatelessWidget {
  const MithaqConversationShimmer({super.key});

  @override
  Widget build(BuildContext context) {
    return const MithaqShimmer(
      child: Padding(
...
class MithaqInterestShimmer extends StatelessWidget {
  const MithaqInterestShimmer({super.key});
