// lib/core/widgets/loaders/noor_blur_image.dart
// ============================================================
// NOOR — Reusable BlurHash Network Image
...
class NoorBlurImage extends StatefulWidget {
  const NoorBlurImage({
    super.key,
  ...
  @override
  State<NoorBlurImage> createState() => _NoorBlurImageState();
}

class _NoorBlurImageState extends State<NoorBlurImage> {
  ...
  @override
  void didUpdateWidget(NoorBlurImage oldWidget) {
