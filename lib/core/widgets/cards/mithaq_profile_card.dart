// lib/core/widgets/cards/mithaq_profile_card.dart
// ============================================================
// The MITHAQ Card — "The Discovery Engine"
...
import '../buttons/mithaq_pressable.dart';
import '../loaders/mithaq_blur_image.dart';

class MithaqProfileCard extends StatelessWidget {
  const MithaqProfileCard({
    super.key,
