...
class OnboardingData {
  ...
  factory OnboardingData.fromJson(Map<String, dynamic> json) {
    return OnboardingData(
      profileFor: json['profileFor'] != null ? ProfileFor.values.byName(json['profileFor'] as String) : null,
      firstName: json['firstName'] as String?,
      lastName: json['lastName'] as String?,
      dateOfBirth: json['dateOfBirth'] != null ? DateTime.tryParse(json['dateOfBirth'] as String) : null,
      gender: json['gender'] != null ? Gender.values.byName(json['gender'] as String) : null,
      ...
      sect: json['sect'] != null ? Sect.values.byName(json['sect'] as String) : null,
      subSect: json['subSect'] as String?,
      deenLevel: json['deenLevel'] != null ? DeenLevel.values.byName(json['deenLevel'] as String) : null,
      ...
      employmentStatus: json['employmentStatus'] != null ? EmploymentStatus.values.byName(json['employmentStatus'] as String) : null,
      ...
      maritalStatus: json['maritalStatus'] != null ? MaritalStatus.values.byName(json['maritalStatus'] as String) : null,
      hasChildren: json['hasChildren'] as bool?,
      childrenCount: json['childrenCount'] as int?,
      livingExpectation: json['livingExpectation'] as String?,
      bio: json['bio'] as String?,
      interests: json['interests'] != null ? List<String>.from(json['interests'] as Iterable) : null,
      languages: json['languages'] != null ? List<String>.from(json['languages'] as Iterable) : null,
      preferredAgeMin: json['preferredAgeMin'] as int?,
      preferredAgeMax: json['preferredAgeMax'] as int?,
      locationPreference: json['locationPreference'] != null ? LocationPreference.values.byName(json['locationPreference'] as String) : null,
      ...
      photoLocalPaths: json['photoLocalPaths'] != null ? List<String>.from(json['photoLocalPaths'] as Iterable) : null,
      photoPrivacy: json['photoPrivacy'] != null ? PhotoPrivacy.values.byName(json['photoPrivacy'] as String) : null,
