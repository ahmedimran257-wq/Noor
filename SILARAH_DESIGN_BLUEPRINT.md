This is the SILARAH Design Blueprint.
...
If a dating app is a "neon-lit club," SILARAH is a "private gallery."
...
2. The "SILARAH Card" (The Discovery Engine)
...
The Splash: The Arabic letterform (?????) glows in the center. Background has a subtle radial gradient (#1A1A2F
?
?
 #0A0A0F).
...
Header: Playfair wordmark "SILARAH" centered. Thin-stroke icons (Lucide/Phosphor).
